<x-admin.maz-sidebar :href="route('admin.dashboard')" :logo="asset('images/logo/logo.png')">
    ...
    <x-admin.maz-sidebar-item name="Inbox" :link="'#'" icon="bi bi-envelope-fill"></x-admin.maz-sidebar-item>

    <x-admin.maz-sidebar-item name="Article" :link="'#'" icon="bi bi-journal-text">
        <x-admin.maz-sidebar-subitem name="Add Article" :link="'#'" icon="bi bi-person"></x-admin.maz-sidebar-subitem>
        <x-admin.maz-sidebar-subitem name="Article List" :link="'#'" icon="bi bi-person"></x-admin.maz-sidebar-subitem>
