<div class='card' submit="updatePassword">
    ...
    <div class="card-body">
        ...
        <x-admin.maz-alert color="success" on="saved">
            {{ __('Saved.') }}
        </x-admin.maz-alert>
        <form wire:submit.prevent="updatePassword">
            ...
            <div class="form-group">
                ...
                <x-admin.maz-input-error for="current_password" />
            </div>
            ...
            <div class="form-group">
                ...
                <x-admin.maz-input-error for="password" />
            </div>
            ...
            <div class="form-group">
                ...
                <x-admin.maz-input-error for="password_confirmation" />
            </div>
